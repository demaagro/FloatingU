...
#[derive(Debug)]
pub struct FloatingUIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FloatingUIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FloatingUI processing");
    
    let mut processor = FloatingUIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FloatingUIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FloatingUIProcessor::new(false);
